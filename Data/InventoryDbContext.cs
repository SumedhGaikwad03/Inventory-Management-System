...
// simply as "Create my database context called InventoryDbContext, and make it an EF Core DbContext"
{
    public InventoryDbContext(
        ...
        : base(options) // options are basicallly configration provided to the system 
        // this is kinda configurred in the program.cs file 
    {
    }

    // These DbSets represent database tables.
    public DbSet<User> Users { get; set; } // Dbset reprsetnsts collection of entities 
    ...
    // overridding the core ef db rules 

    {
        ...
        modelBuilder.Entity<Category>()
            ...
            // the abstraction here is very high its amost like english 
       ...
       // we have two intilaisation of the same becasue EF Core's Fluent API is designed to configure one relationship at a time.
